...
export default function Culture_Places() {
            ...
            <section>
                ...
                <div className="container padding_bottom">
                    <div className="explore_section section_title ">
                        <h2 className="mb-0">Recommended Cultural Experiences for You</h2>
                        <p>Handpicked museums, heritage sites, and cultural hubs to immerse yourself in local traditions</p>
                    </div>
                    {/* *******************************************  show on deskltop >>>>>>>>>>>>>>>>>>>>>> */}
