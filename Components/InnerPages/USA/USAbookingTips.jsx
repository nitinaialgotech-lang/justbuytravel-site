...
export default function USAbookingTips() {
    const [secondActive, setSecondActive] = useState(true);
    const card = [
        {
            img: "/innerpages/usa/us4.webp"
        },
        {
            img: "/innerpages/usa/us1.webp"
        },
        {
            img: "/innerpages/usa/us2.webp"
        },
        {
            img: "/innerpages/usa/us3.webp"
        },
    ]
    return (
        <>
                    ...
                    <div className="row items-center">
                                ...
                                <div className="row ">
                                    <div className="col-lg-6">
                                        <div className="hotel_tips_img">
                                            <img src={getAssetPath("/innerpages/usa/us4.webp")} alt="" />
                                        </div>

                                    </div>
                                    <div className="col-lg-6">
                                        <div className="hotel_tips_img">
                                            <img src={getAssetPath("/innerpages/usa/us1.webp")} alt="" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6  mt-4">
                                        <div className="hotel_tips_img">
                                            <img src={getAssetPath("/innerpages/usa/us2.webp")} alt="" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mt-4 ">
                                        <div className="hotel_tips_img">
                                            <img src={getAssetPath("/innerpages/usa/us3.webp")} alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6 ">
                            <div className="hotel_tips_title">
                                <div className="tips_title">
                                    <h2>
                                        Find Comfort Anywhere – Even at the Last Minute!
                                    </h2>
                                </div>
                        ...
                        <div className="col-lg-12">
                            <div className="hotel_tips_content">
                                <p>
                                    Are you looking for one of the top- rated<span className='g_color font-semibold'> hotel booking websites in Canada?</span> Or are you planning a city tour? We are here to help you out by comparing the premium and <span className='g_color font-semibold'>cheap hotel sites in Canada </span>to find the perfect stay at the lowest price. Explore hidden methods for getting<span className='g_color font-semibold'>hotel discounts in Canada </span> and staying inside your trip budget. From analysing<span className='g_color font-semibold'> Canada hotel prices</span>  to booking smartly via reputable sites, JustBuyTravel makes it simple to get comfort without compromising.
