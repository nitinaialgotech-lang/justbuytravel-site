...
import NearByPunta from './NearByPunta';
import Punta_Iconic_Places from './Punta_Iconic_Places';
import Punta_Booking_Tips from './Punta_Booking_Tips';
import Punta_cana_AmazingDeals from './Punta_cana_AmazingDeals';
import Punta_Faq from './Punta_Faq';


export default function Punta_Recomand() {
    /************************* ustate contetn *** */
    ...
    const { data: nearbyPlacesData, isLoading } = useQuery({
        queryKey: ["lodgingnearby", "Punta Cana"],
        queryFn: () => searchHotel1("Punta Cana"),
    });
