...
import CapTownNearby from './CapTownNearby';
import CapTownIconincs from './CapTownIconincs';
import CapeTownAmazingDeals from './CapeTownAmazingDeals';
import CapTownFaqSection from './CapTownFaqSection';
import { useRouter } from 'next/navigation';

export default function CapTownRecomd() {
    ...
    const { data: nearbyPlacesData, isLoading } = useQuery({
        queryKey: ["lodgingnearby", "cape town"],
        queryFn: () => searchHotel1("cape town"),
    });
