        ...
        <div className="container">
          <div className="row">
            <div className="explore_section section_title m">
              <h2 className="mb-0">Nearby Attractions Around Hotels</h2>
              <p>
                Enjoy quick access to city highlights, historic sites, popular
                restaurants, shopping areas, parks, and family-friendly
