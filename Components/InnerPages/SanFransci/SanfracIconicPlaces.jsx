...
export default function SanfracIconicPlaces() {
  ...
  const { data: iconicPlacesData } = useQuery({
    queryKey: ["iconicPlacesNearby", "San Francisco"],
    queryFn: () => searchTouristAttraction("San Francisco"),
  });
      ...
      <section>
        <div className="container padding_bottom">
          <div className="explore_section section_title ">
            ...
            <p>
              Famous landmarks and popular attractions are located near your
              hotel, making it easy to explore and easily accessible during your
              stay at the hotel.
            </p>
          </div>
          {/* *******************************************  show on deskltop >>>>>>>>>>>>>>>>>>>>>> */}
