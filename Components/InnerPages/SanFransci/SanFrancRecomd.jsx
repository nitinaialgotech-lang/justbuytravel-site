...
import SanFrancNearBy from "./SanFrancNearBy";
    ...
    <>
      ...
      <section className="recomend_section container  padding_bottom">
        <div className="section_title relative ">
          <h2 className="mb-0">Recommended Hotels in San Francisco</h2>
          <p>
            Comfortable hotels in convenient locations offering fair prices,
            clean rooms, helpful service, and easy access to popular attractions
