...
import LondonNearby from './LondonNearby';
import LondonIconic from './LondonIconic';
import LondonBookingTips from './LondonBookingTips';
import LondonAmazingDeals from './LondonAmazingDeals';
import LondonFaqSection from './LondonFaqSection';

export default function LondonRecomand() {
    /************************* ustate contetn *** */
    ...
    const { data: nearbyPlacesData, isLoading } = useQuery({
        queryKey: ["lodgingnearby", "london"],
        queryFn: () => searchHotel1("london"),
    });
