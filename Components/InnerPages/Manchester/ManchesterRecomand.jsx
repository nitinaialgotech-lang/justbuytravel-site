...
import ManchesterBookingTips from "./ManchesterBookingTips";
    ...
    <>
      ...
      <section className="recomend_section container  padding_bottom">
        <div className="section_title relative ">
          <h2 className="mb-0">Recommended Hotel Stays in Manchester</h2>
          <p>
            The hotel is near to Central Manchester, transport links, shopping
            streets and popular landmarks, making it easy to access during your
            visit.
          </p>
