...
export default function ManchesterIconicPlaces() {
  ...
  const { data: iconicPlacesData } = useQuery({
    queryKey: ["iconicPlacesNearby", "Manchester"],
    queryFn: () => searchTouristAttraction("Manchester"),
  });
      ...
      <section>
        <div className="container padding_bottom">
          <div className="explore_section section_title ">
            <h2 className="mb-0">Iconic Places in Manchester</h2>
            <p>
              Popular places to visit in Manchester are easily accessible from
              the surrounding hotel area, so you can easily explore the local
            ...
            <div className="row  relative">
              ...
              >
                {(iconicPlacesList.length
                  ...
                  const slug = placeId
                    ? getPlaceDetailPath("attraction", title, placeId)
                    : "#";
                  return (
                    <SwiperSlide key={i}>
