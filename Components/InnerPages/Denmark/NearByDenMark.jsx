...
export default function NearByDenMark() {
  /********************* states *************** */
  ...
  const { data: nearbyRestaurantsData } = useQuery({
    queryKey: ["restaurantsNearby", "Denmark"],
    queryFn: () => NearbyRestaurant("Denmark"),
  });
        ...
        <div className="container">
          <div className="row">
            <div className="explore_section section_title m">
              <h2 className="mb-0">
                Dining and Local Attractions Near Denmark Hotels
              </h2>
              <p>
                Popular hotel areas in Denmark are close to restaurants, cafes,
                and places to visit, making for easy accommodation planning and
                local experiences.
              </p>
            </div>
          </div>
