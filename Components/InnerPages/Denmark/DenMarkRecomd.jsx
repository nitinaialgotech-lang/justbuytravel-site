    ...
    <>
      ...
      <section className="recomend_section container  padding_bottom">
        <div className="section_title relative ">
          <h2 className="mb-0">Top Rated Hotels to Stay in Denmark</h2>
          <p>
            Stay in comfortable hotels near Denmark's popular cities,
            attractions, business districts and tourist destinations for easy
            travel planning.
          </p>
