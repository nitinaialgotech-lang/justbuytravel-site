...
import MiamiNearBy from './MiamiNearBy';
import MiamiIconic from './MiamiIconic';
import MiamiBookingTips from './MiamiBookingTips';
import MiamiAmazingDeals from './MiamiAmazingDeals';
import MiamiFaqSection from './MiamiFaqSection';



export default function MiamiRecomd() {
    /************************* ustate contetn *** */
    ...
    const { data: nearbyPlacesData, isLoading } = useQuery({
        queryKey: ["lodgingnearby", "miami"],
        queryFn: () => searchHotel1("miami"),
    });
