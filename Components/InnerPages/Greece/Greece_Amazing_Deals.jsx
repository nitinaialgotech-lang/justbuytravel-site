...
export default function Greece_Amazing_Deals() {
    return (
                ...
                <div className="row">
                    <div className="col-lg-12">
                        ...
                        <div className="hotel_tips_content amazing_deals_content ">
                            ...
                            <p>
                                Many travellers choose to <Link href={"/hotels-in-paris"} className='g_color '> book hotels in Paris</Link>  that balance comfort, location, and fair pricing. From stylish boutique stays to well-known luxury hotels in Paris, understanding what each area offers helps travellers make better choices. Central neighbourhoods provide easy access to attractions, dining, and transport, while quieter districts suit those who prefer a relaxed pace. Those travelling between major European cities can also explore <Link href={"/hotels-in-manchester"} className='g_color '> hotels in Manchester</Link> as part of their journey.
                            </p>
                            <p>
