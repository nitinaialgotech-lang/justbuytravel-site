...
import Greece_NearBy from './Greece_NearBy';
import Iconic_Greece from './Iconic_Greece';
import Greece_Booking_Tips from './Greece_Booking_Tips';
import Greece_Amazing_Deals from './Greece_Amazing_Deals';
import Greece_Faq from './Greece_Faq';


export default function Greece_Recomnd() {
    /************************* ustate contetn *** */
    ...
    const { data: nearbyPlacesData, isLoading } = useQuery({
        queryKey: ["lodgingnearby", "greece"],
        queryFn: () => searchHotel1("greece"),
    });
