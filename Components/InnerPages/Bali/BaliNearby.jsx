...
/******************* stqart function */
export default function BaliNearby() {
    /********************* states *************** */
    ...
    const { data: nearbyRestaurantsData, isLoading } = useQuery({
        queryKey: ["restaurantsNearby", "bali"],
        queryFn: () => NearbyRestaurant("bali"),
    });
           ...
           */}
                    <div className="container relative">
                        <div className="row ">
                            ...
                            >
                                {nearbyRestaurantsData?.length || isLoading ? Array.from({ length: 4 }).map((_, i) => (
