        ...
        <>
            ...
            <section className="recomend_section container  padding_bottom">
                <div className="section_title relative ">
                    <h2 className="mb-0">Top Rated Hotels in Dubai</h2>
                    <p>Highly rated and popular hotels in Dubai selected based on guest reviews, location convenience, amenities, and overall value for money.
                    </p>
