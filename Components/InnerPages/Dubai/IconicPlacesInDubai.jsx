...
/****************************** start function >>>>>>>>>>>> >>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
export default function IconicPlacesInDubai() {
  /************ state start ******** */
  ...
  const { data: iconicPlacesData } = useQuery({
    queryKey: ["iconicPlacesNearby", "Dubai"],
    queryFn: () => searchTouristAttraction("Dubai"),
  });
      ...
      <section>
        <div className="container padding_bottom">
          <div className="explore_section section_title ">
            <h2 className="mb-0">Iconic Places to Visit in Dubai</h2>
            <p>
              Explore top Dubai landmarks and book hotels near popular sights
              like Dubai Frame, IMG Worlds of Adventure and Dubai Aquarium.
            </p>
          </div>
          {/* *******************************************  show on deskltop >>>>>>>>>>>>>>>>>>>>>> */}
