...
/******************* stqart function */
export default function DubaiNearByPlaces() {
    /********************* states *************** */
    ...
    const { data: nearbyRestaurantsData } = useQuery({
        queryKey: ["restaurantsNearby", "Dubai"],
        queryFn: () => NearbyRestaurant("Dubai"),
    });
                ...
                <div className="container">
                    <div className="row">
                        <div className="explore_section section_title m">
                            <h2 className="mb-0">Popular Restaurants & Attractions Near Dubai Hotels</h2>
                            <p>Discover restaurants, rooftop lounges, and iconic experiences located close to major Dubai hotel districts.</p>
                        </div>
                    </div>
