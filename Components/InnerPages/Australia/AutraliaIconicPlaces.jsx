      ...
      <section>
        <div className="container padding_bottom">
          <div className="explore_section section_title ">
            <h2 className="mb-0">Famous Places to Visit</h2>
            <p>
              Popular visitor places situated near hotel locations for quick
              visits and better access to local attractions during your stay.
            </p>
          </div>
          {/* *******************************************  show on deskltop >>>>>>>>>>>>>>>>>>>>>> */}
