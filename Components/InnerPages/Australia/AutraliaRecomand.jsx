    ...
    <>
      ...
      <section className="recomend_section container  padding_bottom">
        <div className="section_title relative ">
          <h2 className="mb-0">Recommended Hotels in Australia</h2>
          <p>
            Hotel accommodation is available in large areas of Australia, near
            to transport links, dining locations and local sights, making your
            stay easy.
          </p>
