...
export default function IconicPlaceInIreland() {
  ...
  const { data: iconicPlacesData } = useQuery({
    queryKey: ["iconicPlacesNearby", "Ireland"],
    queryFn: () => searchTouristAttraction("Ireland"),
  });
      ...
      <section>
        <div className="container padding_bottom">
          <div className="explore_section section_title ">
            <h2 className="mb-0">Iconic Places Around Ireland</h2>
            <p>
              Famous castles, parks, and heritage attractions located near
              popular areas across Ireland for convenient sightseeing during
              your stay.
            </p>
          </div>
          {/* *******************************************  show on deskltop >>>>>>>>>>>>>>>>>>>>>> */}
