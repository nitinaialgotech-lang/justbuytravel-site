...
export default function IconicPlacesInParis() {
  ...
  const { data: iconicPlacesData } = useQuery({
    queryKey: ["iconicPlacesNearby", "Paris"],
    queryFn: () => searchTouristAttraction("Paris"),
  });
      ...
      <section>
        <div className="container padding_bottom">
          <div className="explore_section section_title ">
            <h2 className="mb-0">Famous & Iconic Places in Paris</h2>
            <p>
              Visit famous landmarks, picturesque streets, historic buildings,
              riverside views and iconic places that truly showcase the charm of
              Paris.{" "}
            </p>
          </div>
          {/* *******************************************  show on deskltop >>>>>>>>>>>>>>>>>>>>>> */}
