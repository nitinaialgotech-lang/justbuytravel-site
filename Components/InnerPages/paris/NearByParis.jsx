...
export default function NearByParis() {
  /********************* states *************** */
  ...
  const { data: nearbyRestaurantsData } = useQuery({
    queryKey: ["restaurantsNearby", "Paris"],
    queryFn: () => NearbyRestaurant("Paris"),
  });
        ...
        <div className="container">
          <div className="row">
            <div className="explore_section section_title m">
              <h2 className="mb-0">Top Nearby Locations in Paris</h2>
              <p>
                Beautiful neighborhood corners, historic streets, rooftop
                terraces, boutique shops, and authentic Parisian experiences are
                easy to find.
              </p>
            </div>
          </div>
