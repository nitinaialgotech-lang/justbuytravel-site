...
import GoaNearByPlaces from "./GoaNearByPlaces";
    ...
    <>
      ...
      <section className="recomend_section container  padding_bottom">
        <div className="section_title relative ">
          <h2 className="mb-0">Popular Hotels in Goa Based on Guest Ratings</h2>
          <p>
            Accommodation options in Goa's coastal areas are close to famous beaches, vibrant markets, popular tourist attractions, beautiful sights and vibrant nightlife.
          </p>
