...
export default function IconicGoaPlaces() {
  /************ state start ******** */
  ...
  const { data: iconicPlacesData } = useQuery({
    queryKey: ["iconicPlacesNearby", "Goa"],
    queryFn: () => searchTouristAttraction("Goa"), //IconicPlaces function is used to fetch iconic places
  });
