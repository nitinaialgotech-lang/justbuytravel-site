...
export default function NearByGlasGow() {
  /********************* states *************** */
  ...
  const { data: nearbyRestaurantsData } = useQuery({
    queryKey: ["restaurantsNearby", "Glasgow"],
    queryFn: () => NearbyRestaurant("Glasgow"),
  });
        ...
        <div className="container">
          <div className="row">
            <div className="explore_section section_title m">
              <h2 className="mb-0">
                Places to Visit Near Your Stay in Glasgow
              </h2>
              <p>
                Restaurants, cafes, and visitor spots located close to popular
                hotel areas across Glasgow for easier dining access and local
                travel planning.
              </p>
            </div>
          </div>
