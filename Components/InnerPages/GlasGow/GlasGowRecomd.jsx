...
import NearByGlasGow from "./NearByGlasGow";
...
export default function GlasGowRecomd() {
  ...
  const { data: nearbyPlacesData, isLoading } = useQuery({
    queryKey: ["lodgingnearby", "Glasgow"],
    queryFn: () => searchHotel1("Glasgow"),
  });
      ...
      <div className="card_col">
        <div className="recommend_card_box card_rounded recomand_card_shadow margin_lr">
          <div className="card_box">
            {/* IMAGE */}
            <div className="card_box_img card_rounded relative overflow-hidden shimmer-bg shimmer-min-250" />
    ...
    <>
      ...
      <section className="recomend_section container  padding_bottom">
        <div className="section_title relative ">
          <h2 className="mb-0">Comfortable Places to Stay in Glasgow</h2>
          <p>
            Hotel options are located near Glasgow city centre, transport hubs,
            restaurants and places to visit for easy access during your stay.
          </p>
