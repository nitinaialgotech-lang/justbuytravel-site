        ...
        <div className="container">
          <div className="row">
            <div className="explore_section section_title m">
              <h2 className="mb-0">Locations Near Canada Hotels</h2>
              <p>
                You can check nearby restaurants, cafes, and local places
                located close to your hotel for convenient dining and quick
                visits during stay.
              </p>
            </div>
          </div>
