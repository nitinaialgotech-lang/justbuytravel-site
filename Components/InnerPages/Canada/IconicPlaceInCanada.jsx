      ...
      <section>
        <div className="container padding_bottom">
          <div className="explore_section section_title ">
            <h2 className="mb-0">Iconic Attractions in Canada</h2>
            <p>
              Popular landmarks and well known attractions located near hotel
              areas across Canada for easier local visits and sightseeing during
              your stay.
            </p>
          </div>
          {/* *******************************************  show on deskltop >>>>>>>>>>>>>>>>>>>>>> */}
