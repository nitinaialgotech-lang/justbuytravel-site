...
export default function CanadaRecomd() {
  ...
  const { data: nearbyPlacesData, isLoading } = useQuery({
    queryKey: ["lodgingnearby", "canada"], // ["lodgingnearby", lat, long]
    ...
    <>
      ...
      <section className="recomend_section container  padding_bottom">
        <div className="section_title relative ">
          <h2 className="mb-0">Where to Stay in Canada</h2>
          <p>
            Choose comfortable hotels in bustling cities, beautiful towns and
            popular destinations, offering convenience, value and a great stay
            for every traveler.
          </p>
